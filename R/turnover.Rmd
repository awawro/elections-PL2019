...
There is a clear correlation if all powiats are considered (blue line), but it seemed that it might be largely driven by the group of '100% urban voters' powiats, which belong in fact 'cities with powiat rights' - a special category of powiats. Excluding these points completely changes the result (red line) - correlation is no longer observed.
